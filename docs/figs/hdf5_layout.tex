...
\begin{tikzpicture}[diagram]
  ...
  \node (events) [dataset] {QuakeML (events)};

  \node (waveforms) [group, below=of events] {Waveforms};

  \node (wf-st0) [group, below=of waveforms, subset] {\variable{NET.STA}};
  \node (st0-metadata) [dataset, below=of wf-st0, subset] {StationXML};
  \node (wf-st0-data0) [dataset, below of=st0-metadata] {\variable{NET.STA.LOC.CHA\_\_START\_\_END\_\_TAG}};
  \node (wf-st0-data1) [dataset, below of=wf-st0-data0] {\variable{NET.STA.LOC.CHA\_\_START\_\_END\_\_TAG}};

  \node (wf-st1) [group, below=of waveforms, subset] {\variable{NET.STA}};
  \node (st1-metadata) [dataset, below=of wf-st0, subset] {StationXML};
  \node (wf-st1-data0) [dataset, below of=st0-metadata] {\variable{NET.STA.LOC.CHA\_\_START\_\_END\_\_TAG}};

  \node (auxdata) [group, below=of waveforms, yshift=-18em] {AuxiliaryData};
  
  \node (eventid) [group, yshift=-5in] {\variable{eventid}};
